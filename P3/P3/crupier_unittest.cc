...
TEST(Crupier, ConstructorParametros) {
    Crupier c("2", "44XX", "Carlos", "Gutierrez", "C/ Mesa 1", "Aguilar", "Sevilla", "España");
...
TEST(Crupier, ConstructorCopiaDefecto) {
  Crupier p("3", "55XX", "Carlos", "Gutierrez", "C/ Mesa 1", "Aguilar", "Sevilla", "España");
  Crupier q(p);
...
TEST(Crupier, OperadorIgual) {
  Crupier p("4", "66XX", "Carlos", "Gutierrez", "C/ Mesa 1", "Aguilar", "Sevilla", "España");
  Crupier q("5", "77FF");
  q=p;
